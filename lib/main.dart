...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer5<ThemeProvider, AuthProvider, SelectedProvider,
            CreatedProvider, MediaQueryProvider>(
        builder: (context, themeProvider, authProvider, selectedProvider,
            CreatedProvider, MediaQueryProvider, _) {
      return MaterialApp(
